<!--
    {
        "name":"Use Select AI Sample Chat App",
        "description":"Use the chat application for Select AI that's available on Github",
        "author":"Marty Gubar",
        "last_updated":"Marty Gubar, ADB Product Management, April 2025"
    }
-->
# Use the Select AI Sample Application
...
>**Note:** This application is available in the [oracle-autonomous-database-samples GitHub repo](https://github.com/oracle-devrel/oracle-autonomous-database-samples/tree/main/apex).
...
* As the `moviestream` user, access the **Select AI demo** application using the URL that you saved in a text editor file in **Lab 1: Set up your environment**. If you didn't save the URL, refer to **Lab 1 > Task 2** to find it using the **Outputs** link in the **Resources** section on the **Job details** page.
...
1. Copy the **Select AI demo** application URL that you saved in a text editor.
    ...
    ![Enter ADB Chat credentials](./images/ai-select-credentials.png =70%x*)

2. On the **ADB Chat** page, select a profile that you want to use from the **Choose subject areas** drop-down list. In this workshop, select the **`moviestream_analytics`** profile that was created in the previous lab.
