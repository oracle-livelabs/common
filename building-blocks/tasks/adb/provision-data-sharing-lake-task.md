...
1. Log in to the **Oracle Cloud Console** as the Cloud Administrator, if you are not already logged in using the **Get Started** lab in the navigation tree on the left . You will complete all the labs in this workshop using this Cloud Administrator.
   See [Signing In to the Console](https://docs.cloud.oracle.com/en-us/iaas/Content/GSG/Tasks/signingin.htm) in the _Oracle Cloud Infrastructure_ documentation.

2. The **Oracle Cloud Console** Home page, click the **Navigation** menu to open it.

   ![The partial Oracle Cloud Console Home Page is displayed.](./images/oracle-cloud-console-home.png =65%x*)
...
10. In the **Backup** section, specify the following:
...
11. In the **Administrator credentials creation** section, specify the following:
...
12. In the **Network access** section, select one of the following options:
