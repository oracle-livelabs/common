...
var freesqlEmbedLoader = "https://livelabs.oracle.com/cdn/common/redwood-hol/js/freesql-embed-loader.min.js";
...
let main = function () {
    ...
    const loadTutorial = function (articleElement, selectedTutorial, manifestFileContent, callbackFunc = null) {
        ...
        $.get(tut_fname, function (markdownContent) { //reading MD file in the manifest and storing content in markdownContent variable
            ...
            markdownContent = convertQuizBlocks(markdownContent, tut_fname); // converts ```quiz blocks to interactive quiz HTML
