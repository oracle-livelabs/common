...
1.  To start the Oracle Cloud shell, go to your Cloud console and click the cloud shell icon at the top right of the page.
    ...
    ![Cloud shell open.](https://raw.githubusercontent.com/oracle-livelabs/common/main/images/console/cloud-shell.png " ")
...
1.  Open the PuTTY utility from the Windows start menu. In the dialog box, enter the IP address of your OCI Compute Instance. This can be obtained from the **OCI Console > Compute > Instances > Instance Details** screen.
    ...
    ![Compute Instance Console.](https://raw.githubusercontent.com/oracle-livelabs/common/main/images/console/compute-instances.png " ")
