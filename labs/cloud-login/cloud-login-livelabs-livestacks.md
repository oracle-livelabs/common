...
1. Above the workshop instructions, you can find the information and actions you need to access and track your sandbox session:
    ...
    ![View Login Info](./images/livestack-landing-page.png " ")


2. Click **View Login Info** to see your detailed reservation information such as username, password and links to the SQL Worksheet login page, as well as the **Workshop Demo**.
...
4. Select Open Link on the 2 - SQL Worksheep row to to open the SQL Worksheet login page.
...
5. From the Oracle REST Data Services page, select SQL Developer Web.
