...
Welcome! This quick guide will help you publish your custom image to Oracle Marketplace.
...
As of November 21st, all Oracle Marketplace listings will need to be created via the OCI console. Please use the following OCI documentation to learn how to publish your image via the OCI console.

1. [Create an artifact.](https://docs.oracle.com/en-us/iaas/Content/Marketplace/Tasks/create-artifact.htm)
2. [Create a listing.](https://docs.oracle.com/en-us/iaas/Content/Marketplace/Tasks/creating-oci-application-listing.htm) (*using this [logo](https://cloudmarketplace.oracle.com/marketplace/content?contentId=95549453)*)
3. [Publish your listing.](https://docs.oracle.com/en-us/iaas/Content/Marketplace/Tasks/publish-listing.htm)
...
* **Last Updated By/Date** - Brianna Ambler, Database Product Manager, October 2025