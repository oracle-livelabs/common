...
Use `/Users/mkowalik/projects/codey/workspace/livestack/guide` as the canonical local example when it exists. If that path is unavailable, use this reference as the portable baseline.
