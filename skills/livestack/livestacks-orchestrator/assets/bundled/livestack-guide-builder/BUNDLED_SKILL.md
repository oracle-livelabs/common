...
Use `/Users/mkowalik/projects/codey/workspace/livestack/guide` as the local reference standard when it is available. If that path is not present, follow the bundled references in this skill.
