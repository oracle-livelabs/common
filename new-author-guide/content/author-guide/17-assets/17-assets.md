...
The Workshop Management System (WMS) supports self-service asset management. Workshop owners can upload, manage, and share reusable files or external links without opening a support request. WMS stores files in Object Storage and stores links in the database. Uploaded files automatically return a ready-to-use, overwriteable PAR link.
...
5. The Asset Details dialog displays options to upload a file or upload a link.
...
Files uploaded to Object Storage automatically return a ready-to-use, overwriteable PAR link. To access it:
