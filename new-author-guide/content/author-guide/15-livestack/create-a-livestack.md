...
LiveStacks are available across Finance, Retail, Healthcare, Media & Entertainment, and Energy & Utilities. Open LiveStacks from LiveLabs to explore content, subscribe for updates, and share solutions with customers and colleagues.
...
5. WMS opens the LiveStack Details page.

    ![LiveStack details page](images/ls-details.png " ")

6. Add LiveLabs and assets as LiveStack content from the details page.
...
2. Search by LiveLab name or ID.

    ![Add a LiveStack entry](images/add-entry-2.png " ")

3. Select the LiveLab and review its override fields.
    * **Run on Sandbox** - This field appears when a LiveLab has a Sandbox Environment. Turn it off when the LiveStack should hide that launch option.
    * **Run on Your Tenancy** - This field appears when a LiveLab has a Run on Your Tenancy option. Turn it off when the LiveStack should hide that launch option.
    * **Title** - WMS starts with the original title. Change it when the LiveStack needs a clearer label.
    * **Position** - Set the display order. You can also drag entries in the report view.
...
A LiveStack can include assets that support its content, as shown below.
...
3. To order assets, update the position value or drag them in the report view.

    ![Configure a LiveStack asset](images/add-asset-3.png " ")

4. Use the visibility switch to set the asset as internal or external. **Internal** assets appear only to Oracle employees. **External** assets appear to anyone who can view the LiveStack.
...
1. When the LiveStack is ready, request publishing by changing its status to 'Publish Requested' and clicking Save.

    ![Request publishing.](images/request-publishing.png " ")

2. The LiveStack council provides a status update in 2 to 3 business days. WMS sends an email notification.
