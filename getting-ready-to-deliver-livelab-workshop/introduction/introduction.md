...
| --- | --- | --- |
| [Lab 1](?lab=lab-1-build-facilitation-runbook) | Build the facilitation runbook. | Confirm venue network, internet, capacity, building access, customer questions, platform-team coordination, and access-control needs. Then assign the facilitator, screen driver, chat/support owner, technical SME, and event coordinator. |
