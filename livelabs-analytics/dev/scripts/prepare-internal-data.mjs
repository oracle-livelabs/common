...
const sourceInventory = readGitJson("inventory/data/portfolio_inventory.json");
const inventoryCount = writeJson("inventory/data/portfolio_inventory.json", readJson("inventory/data/portfolio_inventory.json"), sourceInventory);
const emailCount = restoreHtmlContacts();
console.log(JSON.stringify({ inventoryCount, canonicalPayload: "inventory/data/portfolio_inventory.json", htmlEmailValuesRestored: emailCount }, null, 2));
