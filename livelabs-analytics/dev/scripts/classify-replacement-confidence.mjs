...
if (!files.length) files.push(path.join(projectRoot, "assets", "fragments", "replacement-suggestions.html"));
...
function normalizeFile(filePath) {
  ...
  if (finalSection !== section) fs.writeFileSync(filePath, finalSection, "utf8");
