---
name: polly-status
description: Diagnose Polly enrollment, secure token availability, canonical repository resolution, and server health. Use when Polly context is missing or setup needs verification.
---
