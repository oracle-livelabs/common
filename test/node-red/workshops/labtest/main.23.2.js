...
//         manifestFileName = $(this).children("option:selected").val();
//         // sessionStorage.setItem("SelItem", manifestFileName);
...
if (language == 'en') {
    ...
    manifestFileName = "manifest_de.json"
};
